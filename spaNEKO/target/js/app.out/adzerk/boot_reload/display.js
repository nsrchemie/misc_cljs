...
return (function (p__8510){
var vec__8511 = p__8510;
var attr = cljs.core.nth.call(null,vec__8511,(0),null);
var v = cljs.core.nth.call(null,vec__8511,(1),null);
...
var args8514 = [];
var len__8209__auto___8517 = arguments.length;
var i__8210__auto___8518 = (0);
while(true){
if((i__8210__auto___8518 < len__8209__auto___8517)){
args8514.push((arguments[i__8210__auto___8518]));

var G__8519 = (i__8210__auto___8518 + (1));
i__8210__auto___8518 = G__8519;
continue;
} else {
}
break;
...
var len__8209__auto___8522 = arguments.length;
var i__8210__auto___8523 = (0);
while(true){
if((i__8210__auto___8523 < len__8209__auto___8522)){
args__8216__auto__.push((arguments[i__8210__auto___8523]));

var G__8524 = (i__8210__auto___8523 + (1));
i__8210__auto___8523 = G__8524;
continue;
} else {
}
break;
...
var argseq__8217__auto__ = ((((0) < args__8216__auto__.length))?(new cljs.core.IndexedSeq(args__8216__auto__.slice((0)),(0),null)):null);
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8217__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8521){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8521));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8525){
var map__8529 = p__8525;
...
var data = map__8529__$1;
var message = cljs.core.get.call(null,map__8529__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8529__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8529__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8531 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8531,goog.events.EventType.CLICK,((function (G__8531,map__8529,map__8529__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8531,map__8529,map__8529__$1,data,message,line,file))
);

return G__8531;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8532){
var map__8536 = p__8532;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8539){
var map__8543 = p__8539;
var map__8543__$1 = ((((!((map__8543 == null)))?((((map__8543.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8543.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8543):map__8543);
var messages = map__8543__$1;
var warnings = cljs.core.get.call(null,map__8543__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8543__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8545 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8545,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8545,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8546){
...
var messages = map__8549__$1;
var warnings = cljs.core.get.call(null,map__8549__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8549__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8549,map__8549__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8549,map__8549__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8549,map__8549__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8549,map__8549__$1,messages,warnings,exception))
;
